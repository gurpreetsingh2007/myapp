<template>
  <div class="h-full w-full bg-black text-green-400 font-mono relative overflow-hidden">
    ...
    <div class="relative z-10 p-6">
      <div class="max-w-7xl mx-auto">
        <div v-if="resultData" class="cyberpunk-codeblock mt-6">
          <div class="code-header">
            ...
            <div class="text-xs text-gray-400 font-mono">NEURAL NODE RESPONSES</div>
          </div>
          <pre class="cyberpunk-pre whitespace-pre-wrap">{{ formattedResponse }}</pre>
        </div>
        <!-- Header -->
        <div class="text-center mb-12">
          <h1
            class="text-6xl font-bold bg-gradient-to-r from-cyan-400 via-green-400 to-purple-400 bg-clip-text text-transparent mb-4 animate-pulse"
          >
            DEPLOY TO NETWORK
          </h1>
          <div class="text-xl text-gray-400 font-light tracking-wider">
        ...
        <!-- Main Content Grid -->
        <div v-if="!loading && !error" class="grid grid-cols-1 xl:grid-cols-2 gap-8 mb-12">
          <!-- Server Matrix -->
          <div
            class="bg-gray-900/50 border-2 border-cyan-400/50 rounded-lg backdrop-blur-sm shadow-2xl shadow-cyan-400/20 hover:border-cyan-400 transition-all duration-300"
          >
            <div
              class="px-6 py-4 border-b border-cyan-400/30 bg-gradient-to-r from-gray-900/80 to-gray-800/80"
            >
          ...
          <!-- File Data Stream -->
          <div
            class="bg-gray-900/50 border-2 border-purple-400/50 rounded-lg backdrop-blur-sm shadow-2xl shadow-purple-400/20 hover:border-purple-400 transition-all duration-300"
          >
            <div
              class="px-6 py-4 border-b border-purple-400/30 bg-gradient-to-r from-gray-900/80 to-gray-800/80"
            >
              <div class="flex items-center justify-between">
                <div class="flex items-center space-x-3">
        ...
        <!-- Control Panel -->
        <div v-if="!loading && !error" class="flex flex-col items-center space-y-8">
          <!-- Action Buttons -->
