    ...
    <div class="w-full max-w-5xl mx-auto space-y-8 gap-3 flex flex-col items-center">
      ...
      <div class="grid grid-cols-2 gap-6 mb-8 w-full">
        ...
        >
          ...
          <span class="text-2xl">Add Proxy Block</span>
        </button>
        ...
        >
          ...
          <span class="text-2xl">Add Certificate</span>
        </button>
        ...
        >
          ...
          <span class="text-2xl">Quick Add Domains</span>
        </button>
      </div>
      ...
      <div class="space-y-6 mb-10 w-full">
        ...
        >
          <div class="flex items-center space-x-4">
            ...
            <span class="font-semibold text-gray-800 group-hover:text-[#005188] text-2xl">Reverse Proxy Configuration</span>
          </div>
        ...
        >
          <div class="flex items-center space-x-4">
            ...
            <span class="font-semibold text-gray-800 group-hover:text-[#007C52] text-2xl">SSL/TLS Certificate Management</span>
          </div>
